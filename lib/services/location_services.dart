...
class LocationService {
  ...
  static LocationService instance = LocationService.instance;
    ...
    try {
      ...
      if (status == PermissionStatus.deniedForever) {
        Get.snackbar("Permission Needed",
            "We use permission to get your location in order to give your service and keep you better connected to your partner",
            onTap: (snack) async {
      ...
      print('Error sorting partner location permission: $error');
      rethrow;
    }
  }
/*
